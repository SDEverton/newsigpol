...
export class AppProfile extends Component {
    ...
    async componentDidMount() {
        ...
        await this.setState({ img: url, data: response.data.payload, graduacao: response.data.payload.Graduacao });
    }
    ...
    render() {
        const { nome_guerra, Graduacao } = this.state;
        return  (
            <div className="layout-profile">
                ...
                <button className="p-link layout-profile-link" onClick={this.onClick}>
                    <span className="username">{Graduacao.graduacao } {nome_guerra}</span>
