...
class App extends Component {
  ...
  onToggleMenu(event) {
    const { layoutMode, overlayMenuActive, staticMenuInactive } = this.state;
    this.menuClick = true;
  ...
  componentDidUpdate() {
    const { mobileMenuActive } = this.state;
    if (mobileMenuActive) this.addClass(document.body, 'body-overflow-hidden');
  ...
  render() {
    const logo =
      this.state.layoutColorMode === 'dark'
        ? 'assets/layout/images/sigpol.png'
